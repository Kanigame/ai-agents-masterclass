...
--
-- Name: nocodb_meta; Type: SCHEMA; Schema: -; Owner: supabase_admin
--

CREATE SCHEMA nocodb_meta;


ALTER SCHEMA nocodb_meta OWNER TO supabase_admin;
...
--
-- Name: call_embed_edge_function(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.call_embed_edge_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
BEGIN
    PERFORM
      http_post(
        'https://<your-project>.functions.supabase.co/embed_zettel',
        json_build_object('zettel_id', NEW.id, 'content', NEW.content)::text,
        'application/json'
      );
    RETURN NEW;
END;
...
ALTER FUNCTION public.call_embed_edge_function() OWNER TO supabase_admin;

--
-- Name: delete_zettel_embedding(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.delete_zettel_embedding() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    DELETE FROM public.zettel_vectors WHERE zettel_id = OLD.id;
    RETURN OLD;
END;
$$;


ALTER FUNCTION public.delete_zettel_embedding() OWNER TO supabase_admin;

--
-- Name: get_embedding_ollama(text); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.get_embedding_ollama(input_text text) RETURNS public.vector
    LANGUAGE plpgsql
    AS $$
DECLARE
    response json;
...
ALTER FUNCTION public.get_embedding_ollama(input_text text) OWNER TO supabase_admin;
...
--
-- Name: update_zettel_embedding(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.update_zettel_embedding() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    -- Generate new embedding directly in zettel_cards
    NEW.embedding := get_embedding_ollama(NEW.content);
    RETURN NEW;
END;
$$;


ALTER FUNCTION public.update_zettel_embedding() OWNER TO supabase_admin;
...
162b2d5a-3804-4e28-a1e2-f6e56ca6121c	postgres_cdc_rls	{"region": "us-east-1", "db_host": "QhixI0o7PYIABziLUL4f0A==", "db_name": "sWBpZNdjggEPTQVlI52Zfw==", "db_port": "+enMDFi1J/3IrrquHHwUmA==", "db_user": "uxbEq/zz8DXVD53TOI1zmw==", "slot_name": "supabase_realtime_replication_slot", "db_password": "+CyimFjbElJbpKKkIvNVA0b+HARHxc0Agud0HmEQtjyA0SP0GcNYH25ebccrtxa23DUoQoz3CPMgEpXkCU/KUE82uuGZrojyd3by3+a2jj8=", "publication": "supabase_realtime", "ssl_enforced": false, "poll_interval_ms": 100, "poll_max_changes": 100, "poll_max_record_bytes": 1048576}	realtime-dev	2025-07-14 12:03:18	2025-07-14 12:03:18
\.
...
20210706140551	2025-04-09 10:54:53
20220329161857	2025-04-09 10:54:54
20220410212326	2025-04-09 10:54:54
20220506102948	2025-04-09 10:54:54
20220527210857	2025-04-09 10:54:54
20220815211129	2025-04-09 10:54:54
20220815215024	2025-04-09 10:54:54
20220818141501	2025-04-09 10:54:54
20221018173709	2025-04-09 10:54:54
20221102172703	2025-04-09 10:54:54
20221223010058	2025-04-09 10:54:54
20230110180046	2025-04-09 10:54:54
20230810220907	2025-04-09 10:54:54
20230810220924	2025-04-09 10:54:54
20231024094642	2025-04-09 10:54:54
20240306114423	2025-04-09 10:54:54
20240418082835	2025-04-09 10:54:54
20240625211759	2025-04-09 10:54:54
20240704172020	2025-04-09 10:54:54
20240902173232	2025-04-09 10:54:54
20241106103258	2025-04-09 10:54:54
\.
...
14	use-bytes-for-max-size	941c41b346f9802b411f06f30e972ad4744dad27	2025-04-09 10:54:55.689785
15	add-can-insert-object-function	934146bc38ead475f4ef4b555c524ee5d66799e5	2025-04-09 10:54:55.794406
16	add-version	76debf38d3fd07dcfc747ca49096457d95b1221b	2025-04-09 10:54:55.810252
17	drop-owner-foreign-key	f1cbb288f1b7a4c1eb8c38504b80ae2a0153d101	2025-04-09 10:54:55.840959
18	add_owner_id_column_deprecate_owner	e7a511b379110b08e2f214be852c35414749fe66	2025-04-09 10:54:55.877651
19	alter-default-value-objects-id	02e5e22a78626187e00d173dc45f58fa66a4f043	2025-04-09 10:54:56.043959
20	list-objects-with-delimiter	cd694ae708e51ba82bf012bba00caf4f3b6393b7	2025-04-09 10:54:56.080584
21	s3-multipart-uploads	8c804d4a566c40cd1e4cc5b3725a664a9303657f	2025-04-09 10:54:56.147006
22	s3-multipart-uploads-big-ints	9737dc258d2397953c9953d9b86920b8be0cdb73	2025-04-09 10:54:56.370115
23	optimize-search-function	9d7e604cddc4b56a5422dc68c9313f4a1b6f132c	2025-04-09 10:54:56.485544
24	operation-function	8312e37c2bf9e76bbe841aa5fda889206d2bf8aa	2025-04-09 10:54:56.49429
25	custom-metadata	d974c6057c3db1c1f847afa0e291e6165693b990	2025-04-09 10:54:56.514425
26	objects-prefixes	ef3f7871121cdc47a65308e6702519e853422ae2	2025-04-09 10:54:56.560354
27	search-v2	33b8f2a7ae53105f028e13e9fcda9dc4f356b4a2	2025-04-09 10:54:56.955469
28	object-bucket-name-sorting	ba85ec41b62c6a30a3f136788227ee47f311c436	2025-04-09 10:54:57.216005
29	create-prefixes	a7b1a22c0dc3ab630e3055bfec7ce7d2045c5b7b	2025-04-09 10:54:57.23844
30	update-object-levels	6c6f6cc9430d570f26284a24cf7b210599032db7	2025-04-09 10:54:57.259482
31	objects-level-index	33f1fef7ec7fea08bb892222f4f0f5d79bab5eb8	2025-04-09 10:54:57.30375
32	backward-compatible-index-on-objects	2d51eeb437a96868b36fcdfb1ddefdf13bef1647	2025-04-09 10:54:57.361888
33	backward-compatible-index-on-prefixes	fe473390e1b8c407434c0e470655945b110507bf	2025-04-09 10:54:57.416144
34	optimize-search-function-v1	82b0e469a00e8ebce495e29bfa70a0797f7ebd2c	2025-04-09 10:54:57.41912
35	add-insert-trigger-prefixes	63bb9fd05deb3dc5e9fa66c83e82b152f0caf589	2025-04-09 10:54:57.497534
36	optimise-existing-functions	81cf92eb0c36612865a18016a38496c530443899	2025-07-14 10:00:20.833775
37	add-bucket-name-length-trigger	3944135b4e3e8b22d6d4cbb568fe3b0b51df15c1	2025-07-14 10:00:21.237962
\.
...
initial	2025-04-09 10:54:10.57434+00
20210809183423_update_grants	2025-04-09 10:54:10.57434+00
\.
...
--
-- Name: SCHEMA nocodb_meta; Type: ACL; Schema: -; Owner: supabase_admin
--

GRANT ALL ON SCHEMA nocodb_meta TO postgres;
...
--
-- Name: FUNCTION call_embed_edge_function(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.call_embed_edge_function() TO postgres;
...
--
-- Name: FUNCTION delete_zettel_embedding(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.delete_zettel_embedding() TO postgres;
GRANT ALL ON FUNCTION public.delete_zettel_embedding() TO anon;
GRANT ALL ON FUNCTION public.delete_zettel_embedding() TO authenticated;
GRANT ALL ON FUNCTION public.delete_zettel_embedding() TO service_role;


--
-- Name: FUNCTION get_embedding_ollama(input_text text); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.get_embedding_ollama(input_text text) TO postgres;
GRANT ALL ON FUNCTION public.get_embedding_ollama(input_text text) TO anon;
GRANT ALL ON FUNCTION public.get_embedding_ollama(input_text text) TO authenticated;
GRANT ALL ON FUNCTION public.get_embedding_ollama(input_text text) TO service_role;
...
--
-- Name: FUNCTION update_zettel_embedding(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.update_zettel_embedding() TO postgres;
GRANT ALL ON FUNCTION public.update_zettel_embedding() TO anon;
GRANT ALL ON FUNCTION public.update_zettel_embedding() TO authenticated;
GRANT ALL ON FUNCTION public.update_zettel_embedding() TO service_role;
...
--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: nocodb_meta; Owner: supabase_admin
--

ALTER DEFAULT PRIVILEGES FOR ROLE supabase_admin IN SCHEMA nocodb_meta GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES  TO postgres;
